...
export class Game {
    ...
    * @returns {Game}
    */
    static new(size, colours) {
        var ret = wasm.game_new(size, colours);
    ...
    */
    get_board() {
        var ret = wasm.game_get_board(this.ptr);
    ...
    */
    take_turn(position) {
        wasm.game_take_turn(this.ptr, position);
    }
    /**
    * @returns {string}
    */
    get_state() {
        try {
            wasm.game_get_state(8, this.ptr);
